...
public class Jeux extends Observable{
	...
	public void lancerJeu(){
		Jeux jeu = new Jeux();
		Etudiant Etudiant1 = new Etudiant(0, 0, 0,"Le Bon", true);
		Etudiant Etudiant2 = new Etudiant(100, 0, 0,"La Brute", true);
		//Etudiant Etudiant3 = new Etudiant(100, 0, 0,"Le Truand", true);
		//Etudiant Etudiant4 = new Etudiant(100, 0, 0,"Pour réussir l'année", true);
	...
	public boolean getJeuEtudiant(Etudiant etudiant) {
		return etudiant.getJeuEtudiant();
	}
	public void setJeuEtudiant(Etudiant etudiant, boolean jeuEtudiant) {
		etudiant.setJeuEtudiant(jeuEtudiant);
	}
